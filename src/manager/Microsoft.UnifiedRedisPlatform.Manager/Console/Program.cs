...
namespace Microsoft.UnifiedRedisPlatform.ManagementConsole
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("  Go to https://github.com/microsoft/UnifiedRedisPlatform.Core for more details");
            Console.WriteLine("\n\n");
