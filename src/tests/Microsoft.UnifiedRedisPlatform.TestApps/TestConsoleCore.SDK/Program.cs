...
namespace Microsoft.UnifiedRedisPlatform.TestConsoleCore.Latest
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("UNIFIED REDIS PLATFORM (URP) ADMIN SDK APP");
            Console.WriteLine("--------------------------------------");
            Console.WriteLine("  .NET Version: .NET Core 2.2");
            ...
            if (_mode == AdvancedMode)
            {
                ...
                if (defaultConfigChoice.KeyChar == 'Y' || defaultConfigChoice.KeyChar == 'y')
                {
                    ...
                    var configuration = new UnifiedConfigurationOptions()
                    {
                        ...
                        DiagnosticSettings = new Core.Logging.LogConfiguration()
                        {
                            Enabled = true
                        }
                    };
                ...
                Console.WriteLine("\nPlease wait while we create your connection");
            }
